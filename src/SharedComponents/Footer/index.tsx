        ...
        <footer className='footer__container'>
            <section className='name-github__container'>
                ...
                <div className='github-info__container'>
                    ...
                    <h4>Check the GitHub repository <a className='github-link' rel="noopener noreferrer" target="_blank" href="https://github.com/MarcoGarciaKoch/tennis-lesson-planner-app">here</a></h4>
                </div>
            </section>
